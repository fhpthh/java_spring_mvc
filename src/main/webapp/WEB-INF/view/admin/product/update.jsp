            ...
            <head>
                ...
                <script>
                    $(document).ready(() => {
                        ...
                        const productPreview = $("newProduct.image");
                        if(productPreview) {
                            const urlImg = "/images/product/" + productPreview;
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12 mx-auto">
                                            ...
                                            <form:form method="post" action="/admin/product/update"
                                                ...
                                                <div class="mb-3 col-12 col-md-6">
                                                    <img style="max-height: 250px; display: block;" alt="product preview" id="productPreview" />
                                                </div>
                                                <div class="mb-3 col-12 col-md-6">
